                        ...
                        <div className="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                            <div className="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                                ...
                                <div className="intro-x mt-5 xl:mt-16 text-gray-700 text-center xl:text-left">
                                    ...
                                    <br/>
                                    <a className="text-theme-1" target='_blank' href="/assets/legal/OrthEns-CGU.pdf">Condition d'utilisation</a> & <a className="text-theme-1" href="">Politique de confidentialité</a> 
                                </div>
                            </div>
                        </div>
                    </div>
