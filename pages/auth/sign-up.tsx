                            ...
                            <div className="my-auto mx-auto xl:ml-20 bg-white xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                                ...
                                <form method="post" onSubmit={handleSubmit(onSubmit)} action="/api/auth/signin/email">
                                    ...
                                    <div className="intro-x flex items-center text-gray-700 mt-4 text-xs sm:text-sm">
                                        ...
                                        <label className="cursor-pointer select-none" htmlFor="accept-cgu">J'accepte les<a className="text-theme-1 ml-1" href="">conditions d'utilisation</a> d'OthEns.</label>
                                    </div>
                                    <ErrorMessage
                                        errors={errors}
                                        name="acceptCgu"
