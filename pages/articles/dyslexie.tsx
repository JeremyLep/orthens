...
export default function Dashboard({ user }) {
    return (
        <>
            <SeoHead title="OrthEns - Dyslexie" />
            <Layout title={'Dyslexie'}>
                <div className="intro-y news p-5 box mt-8">
                    ...
                    <div className="intro-y text-gray-700 mt-3 text-xs sm:text-sm"> 19 Juin 2024 <span className="mx-1">•</span> <a className="text-theme-1" href="">Troubles</a> <span className="mx-1">•</span> 5 minutes </div>
